<template>
	...
	<mt-header fixed :title="text" v-if="!hide">
	  ...
	  <template v-if="tolink">
	  	<router-link :to="fun.getUrl(tolink)" slot="right" style="font-size:0.9rem">{{totext}}</router-link>
	 	</template>
	</mt-header>	
...
<style lang="scss" rel="stylesheet/scss" scoped>
	...
	.mint-header.is-fixed{border-bottom: 0.0625rem solid #e8e8e8;background: #FFF;z-index: 99;}
	.is-right a{font-size: 10px;}
</style>
