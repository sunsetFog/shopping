...
<style lang="scss" rel="stylesheet/scss" scoped>
	.calendar-box{
		font-family: "Microsoft Yahei";float: left;width: 21.875rem;margin:0 0rem;}
	.month-box{	text-align: center;background-color: #c61b01;line-height: 2.5rem;}
	.month-box span{line-height: 2.5rem;	cursor: pointer;}
	.month-box select{cursor: pointer;color: #fff;margin:0 0.3125rem;font-family: "Microsoft Yahei";outline: none;
	...
	.date-box{padding: 0 0.625rem;width: 100%;text-align: center;border: 0.125rem solid #ccc;border-top: 0;}
	.date-box th,.date-box td{width: 2.5rem;height: 2.8125rem;}
	...
	.red{color: #c61b01;}
	.next-month{margin:0.75rem 0.625rem 0 0;border-top:0.5rem solid transparent;border-bottom:0.5rem solid transparent;border-left:0.75rem solid #fff;float: right;	}
	.pre-month{margin:0.75rem 0 0 0.625rem;border-top:0.5rem solid transparent;border-bottom:0.5rem solid transparent;border-right:0.75rem solid #fff;float: left;}
	.date-hide{display: none;}
	.confirm-box{text-align: center;}
	.confirm-box button{padding: 0.3125rem 1.5625rem;margin:0.625rem 1.25rem;	}
</style>