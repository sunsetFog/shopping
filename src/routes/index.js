...
const Courierrecord = r => require(['../views/member/courier/courier_record'], r);
const Courierdetail = r => require(['../views/member/courier/courier_detail'], r);
...
const routes = [
  ...
  //score
  { path: '/member/integral_activity', component: IntegralActivity, name: 'IntegralActivity', meta: { title: '', foot: true } },
  { path: '/member/Integral_generalization', component: IntegralGeneralization, name: 'IntegralGeneralization', meta: { title: '发起赠送', foot: true } },
  { path: '/member/integral_get_record', component: IntegralGetRecord, name: 'IntegralGetRecord', meta: { title: '领取记录', foot: true} },
  { path: '/member/integral_present', component: IntegralPresent, name: 'IntegralPresent', meta: { title: '积分推广', foot: false } },
  { path: '/member/integral_record', component: IntegralRecord, name: 'IntegralRecord', meta: { title: '赠送记录', foot: true} },
  ...
  { path: '/extension/invalid/:type', component: Present, name: 'invalid', meta: { title: '无效佣金', foot: true } },
  ...
  //推广页
  { path: '/extensionPage', component: ExtensionPage, name: 'ExtensionPage', meta: { title: '推广页', foot: true } },
  { path: '/awardRanking', component: AwardRanking, name: 'AwardRanking', meta: { title: '奖项排行', foot: true } },
  { path: '/recordOfAwards/:id', component: RecordOfAwards, name: 'RecordOfAwards', meta: { title: '奖励记录', foot: true } },
  { path: '/myIncome', component: MyIncome, name: 'MyIncome', meta: { title: '我的收入', foot: true } },
  ...
  //冻结币--支付
  { path: '/member/alipay/:status/:recharge_money/:order_pay_id/:uid/:pid/:tag', component: Alipay, name: 'fre_alipay', meta: { title: '支付宝', foot: true } },
  ...
  { path: '/member/orderrecord/:order_id', component: OrderRecord, name: 'OrderRecord', meta: { title: '汇款记录', foot: true } },
...
//Train ticket 火车票
  ...
  {path: '/cashier_qr', component: cashier_qr, name: 'cashier_qr', meta: {title: '二维码', foot: true,notKeepAlive:true}},
  ...
  { path: '/store/search/:store_id', component: StoreSearch, name: 'StoreSearch', meta: { title: '商品搜索', foot: true } },
  ...
  { path: '/member/extension_apply', component: ExtensionApply, name: 'ExtensionApply', meta: { title: '推广申请' , foot: true} },
  //会员等级列表
  ...
  { path: '/article_list', component: ArticleList, name: 'ArticleList', meta: { title: '文章列表' , foot: true} },


  //开户信息
  { path: '/member/accoutinfo', component: AccoutInfo, name: 'AccoutInfo', meta: { title: '开户信息' , foot: true} },


  //SupplierCenter 供应商管理中心

  { path: '/supplier_center', component: SupplierCenter, name: 'SupplierCenter', meta: { title: '供应商管理' , foot: true} },
  { path: '/commodity_management/:store_id', component: CommodityManagement, name: 'CommodityManagement', meta: { title: '商品管理', foot: true } },
  { path: '/commodity_editor/:store_id/:goods_id', component: CommodityEditor, name: 'CommodityEditor', meta: { title: '商品编辑', foot: true } },
  { path: '/commodity_release/:store_id', component: CommodityRelease, name: 'CommodityRelease', meta: { title: '商品发布', foot: true } },
  //商品分类
  { path: '/goods_classify/:store_id', component: GoodsClassify, name: 'GoodsClassify', meta: { title: '商品分类' , foot: true} },
  { path: '/add_classify/:store_id/:classify_id/:level', component: AddClassify, name: 'AddClassify', meta: { title: '添加分类', foot: true } },
  { path: '/first_edit/:store_id/:classify_id/:level', component: FirstEdit, name: 'FirstEdit', meta: { title: '一级分类', foot: true } },

  // 供应商--信息管理

  { path: '/supplier_info_manage', component: SupInfoManage, name: 'SupInfoManage', meta: { title: '信息管理' , foot: true} },

  //转账
  { path: '/transfer_account/:id', component: TransferAccount, name: 'TransferAccount', meta: { title: '汇款支付' , foot: true} },




  //排队奖励记录
  { path: '/reward_record', component: QueueRecord, name: 'QueueRecord', meta: { title: '奖励记录' , foot: true} },
  //冻结币
  { path: '/frozen_coin', component: FrozenCoin, name: 'FrozenCoin', meta: { title: '充值币' , foot: true} },
  { path: '/recharge_coin', component: RechargeCoin, name: 'RechargeCoin', meta: { title: '充值' , foot: true} },
  { path: '/look_details_coin', component: LookDetailsCoin, name: 'LookDetailsCoin', meta: { title: '查看明细' , foot: true} },
  { path: '/put_forward_coin', component: PutForwardCoin, name: 'PutForwardCoin', meta: { title: '提现' , foot: true} },


  //登录中转页面

  { path: '/login_validate', component: LoginValidate, name: 'LoginValidate', meta: { title: '登录' , foot: true} },

  //快递单
  { path: '/member/courier/courier', component: Courier, name: 'courier', meta: { title: '快递单上传', foot: true } },
  { path: '/member/courier/courier_record', component: Courierrecord, name: 'courierrecord', meta: { title: '上传记录', foot: true } },
  { path: '/member/courier/courier_detail', component: Courierdetail, name: 'courierdetail', meta: { title: '记录详情', foot: true } },
