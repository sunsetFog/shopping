<template>
    <div id="myIncome">
        <c-title :hide="false" text='收入分享'></c-title>
        ...
        <div class="income">
                ...
                <ul class="name">
                    ...
                    <h2 class="d">¥{{obj.month_income }}</h2>
                </ul>
                <div class="profit-box">
                        ...
                        <ul class="profit">
                            <li class="day">
                                <ul class="left">
                                    <h4><span>¥</span>&nbsp;{{obj.today_income}}</h4>
                                    <li>今日利润</li>
                                </ul>
                            </li>
                            <li class="all">
                                <ul class="right">
                                    <h4><span>¥</span>&nbsp;{{obj.total_income}}</h4>
                                    <li>全部利润</li>
                                </ul>
                            </li>
                        </ul> 
...
#myIncome{
    ...
    .income{
        ...
        box-shadow: 0rem 0.75rem 0.88rem 0.12rem rgba(51, 51, 51, 0.08);
        h1,h2,h3,h4{
            color:#333;
        }
        .header{
