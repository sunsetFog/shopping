        ...
        <section class="current">
            ...
            <article class="scrolling">
                <div class="content scroller">
                    <div class="storeHomeNew  store-industry-1" style="min-height: 40.5625rem;" :style="{'position':showStoreInfo ? 'relative' : 'fixed'}">
                        <div class="yq clearfix">
                            ...
                            <div class="qz">
                                ...
                                <p class="yr" style="margin-top: 0.3125rem;"><span class="a25">{{store.business_hours}}</span></p>
                            </div>
                            <div class="a02 " data-focus="0" clstag="pageclick|keycount|store_focus_20160815_1"><!--<i class="a03 "></i>--></div>
                            <div class="yy yz cashier-buy" @click="goBuy" style=""><i class="fa fa-money" aria-hidden="true"></i> <span style="margin-left:0.125rem">买单</span></div>
                            <div class="a0v">
                                <ul class="a1t dh">
...
-->
                    ...
                    <div class="z4 z5" v-show="showGoods">
                        <div class="uw vr" @click="searchJump">
                            <div class="vs">
...
<mt-loadmore v-if="goload" :bottom-method="loadBottom" :bottom-all-loaded="allLoaded" ref="loadmore" bottomPullText='' bottomDropText='下拉加载...' bottomLoadingText='' :autoFill='false' id='olis'>
                                <div class="zi vp " style="height: auto;">
                                    <div class="storePromptWrap a2"  v-if="goodsList.length == 0">暂无数据...
                                    </div>
...
<div style="width: 100%;height: 40px;" v-if="loading == false"></div>
<div class="loadNomore" v-if="loading" style="margin: 0 auto;text-align: center;width: 100%;height: 90px;margin-bottom: 40px;"><img style="width: 80px;height: 60px;" src="../../../assets/images/no-more-product.png"/></div>
            ...
            <div class="a2q" v-show="showGoods">
                ...
                <div class="minicart-content" :style="minicartStyle">
                    ...
                    <div style="height:3.0625rem;" discountpromptmsgheight=""></div>
        ...
        <div class="y5" bottommenus="" @click="showToolbar" style="bottom: 7.1875rem;">
