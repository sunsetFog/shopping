...
<!--<c-myswipe
    ...
    <div v-for="(slide,index) in $store.state.temp.default.ads" :key="index" @click="bannerClick(slide)">
		...
		<div class="c-swipe" style="height:11.25rem">
		<mt-swipe :auto="4000">
	...
	<!--<div class="m-swipe">
		...
		<div class="oads-img">
			<img v-if="bannerData" style="width:100%;height:7.5rem;" :src="bannerData.img"  @click="bannerClick(bannerData)">
		</div>
		<div>
		<!-- <div style="height:100%;overflow:scroll;-webkit-overflow-scrolling:touch;"> -->
			...
			<c-storeList :stores='stores' :loading='loading' text='附近的店铺'></c-storeList>
			<!-- </mt-loadmore> -->
		</div>
		<yd-button-group style="padding:0;">
        	<yd-button size="large" type="hollow" @click.native="getMoreData" v-if="activeMore" class="more-btn" style="width:100%;padding:0px;height:2.25rem;font-size:12px;border:0;color:8c8c8c;">加载更多...</yd-button>
    	</yd-button-group>
