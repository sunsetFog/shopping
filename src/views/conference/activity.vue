<template>
	<div id="all">
		...
		<div id="member">
			<div id="tool" style="padding-left:0.75rem;">
				<dt v-if="thumb"><img v-lazy="thumb" style="width: 100% ;height: 6.25rem;"/></dt>
				<dt v-if="!thumb"><img src="../../../static/app/images/coupon.png" style="width: 100% ;height: 6.25rem;" /></dt>
			...
			<div style="height: 0.625rem;clear: both;"></div>
			<yd-popup v-model="intro" position="left" height="100%" width="100%">
				<yd-navbar height="2.5rem" fontsize="16px" title="活动详情">
					<span slot="right" @click="intro=false">
						<yd-icon class="iconfont icon-guanbi" custom size="1rem"></yd-icon>
					</span>
				</yd-navbar>
				<yd-layout class="intro">
					<div v-html="conference.content" style="text-align:left;"></div>
				</yd-layout>
			</yd-popup>
			<!-- 组件部分 -->
			<div class="diyform">
