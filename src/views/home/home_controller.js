...
export default {
    ...
    methods: {
        ...
        gotoBrand(item){
            this.$router.push(this.fun.getUrl('brandgoods', {id:item.id}));
        },
    ...
    components: { cTitle, cMent, cGoodsList, banner, showbanner, showsign, showmenu, showtitle, showsearch, showline, showblank, showrichtext, showpicture, showcube, showarea, showshop, showgoods, shownotice, showlocation, showstore, cMyswipe, Swipe, SwipeItem,showcoupon,showheadline,showarticle,showflashsale },
