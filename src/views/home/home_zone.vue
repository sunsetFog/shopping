<template>
    <div id="area-select">
        ...
        <div class="search-box">
            <div class="search">
                <yd-icon class="iconfont icon-sousuo1" custom size="1rem" color="#999"></yd-icon>
                ...
                <!-- <div v-for="(item,index) in province">
                                        ...
                                        <transition name="fade">
                                               ...
                                               <div class="tbs3" v-show='sort==index'>
                                                    <div v-for="(val,i) in item.item1">{{val.name}}</div>
                                                </div>
                                            
                                             <div class="tbs3" v-show='sort==index'>1111</div>
                                        </transition>
                                    </div> -->
                <div v-for="(item,index) in province">
                    <div class="tbs" @click='toggle($event,index)'>
                    ...
                    <transition name="fade">
                        <div class="tbs3" v-show='sort==index'>
                            <div v-for="(val,i) in item.item1" style="line-height:1.875rem;border-bottom:0.0625rem;">
