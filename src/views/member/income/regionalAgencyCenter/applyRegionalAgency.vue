<template>
    <div id="areaAgent">
        ...
        <mt-popup v-model="selshow" position="left" style="width:100%;height:100%;padding-top:2.5rem;" popup-transition="popup-fade">
          <yd-navbar title="代理等级" height="2.5rem" fontsize="16px" fixed>
				<span slot="left">
					<yd-navbar-back-icon @click.native="selshow = false"></yd-navbar-back-icon>
				</span>
		  </yd-navbar>
		 <!-- <div style="clear:both;margin-top:40px;"></div> -->
         <yd-cell-item arrow v-for="item in level" @click.native="selConfirm(item)">
				<span slot="left">{{item.name}}</span>
		</yd-cell-item>
       </mt-popup>

       <mt-popup v-model="proshow" position="left" style="width:100%;height:100%;padding-top:2.5rem;" popup-transition="popup-fade">
          <yd-navbar title="省级区域" height="2.5rem" fontsize="16px" fixed>
				<span slot="left">
					<yd-navbar-back-icon @click.native="proshow = false"></yd-navbar-back-icon>
				</span>
		  </yd-navbar>
		 <!-- <div style="clear:both;margin-top:40px;"></div> -->
         <div class="scroll">
              <yd-cell-item arrow v-for="item in provinceoptions" @click.native="selectProviceHandle(item)">
       ...
       <mt-popup v-model="cityshow" position="left" style="width:100%;height:100%;padding-top:2.5rem;" popup-transition="popup-fade">
          <yd-navbar title="市级区域" height="2.5rem" fontsize="16px" fixed>
				<span slot="left">
					<yd-navbar-back-icon @click.native="cityshow = false"></yd-navbar-back-icon>
				</span>
		  </yd-navbar>
		 <!-- <div style="clear:both;margin-top:40px;"></div> -->
         <div class="scroll">
         <yd-cell-item arrow v-for="item in cityoptions" @click.native="selectCityHandle(item)">
				<span slot="left">{{item.areaname}}</span>
		</yd-cell-item>
        </div>
       </mt-popup>

       <mt-popup v-model="regshow" position="left" style="width:100%;height:100%;padding-top:2.5rem;" popup-transition="popup-fade">
          <yd-navbar title="区/县级区域" height="2.5rem" fontsize="16px" fixed>
				<span slot="left">
					<yd-navbar-back-icon @click.native="regshow = false"></yd-navbar-back-icon>
				</span>
		  </yd-navbar>
		 <!-- <div style="clear:both;margin-top:40px;"></div> -->
         <div class="scroll">
             <yd-cell-item arrow v-for="item in regionoptions" @click.native="selectRegionHandle(item)">
				<span slot="left">{{item.areaname}}</span>
		    </yd-cell-item>
         </div>
       ...
       <mt-popup v-model="streetshow" position="left" style="width:100%;height:100%" popup-transition="popup-fade">
         ...
         <div class="scroll">
             <yd-cell-item arrow v-for="item in stroptions" @click.native="selectStrionHandle(item)">
				<span slot="left">{{item.areaname}}</span>
		    </yd-cell-item>
         </div>
