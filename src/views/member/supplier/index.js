 ...
 */
const fashion = r => require(['../views/fashion/fashion'], r);
...
const commodityManagement = r => require(['../views/member/supplier/commodityManagement/commodityManagement'], r);
const commodityEditor = r => require(['../views/member/supplier/commodityManagement/commodityEditor'], r);
const commodityRelease = r => require(['../views/member/supplier/commodityManagement/commodityRelease'], r);
const selectionClassification = r => require(['../views/member/supplier/commodityManagement/selectionClassification'], r);
...
// 页面路由
const routes = [
	{ path: '/fashion', component: fashion, name: 'fashion', meta: { title: 'fashion', foot: false } },
  ...
  { path: '/diy', component: Diy, name: 'Diy',meta: { title: '装修', foot: false }  },
  ...
  { path: '/member/supplier', component: Supplier, name: 'supplier', meta: { title: '供应商申请', foot: true } },
	//bingo
{ path: '/member/supplier/commodityManagement', component: commodityManagement, name: 'commodityManagement', meta: { title: '供应商申请', foot: true } },
{ path: '/member/supplier/commodityEditor', component: commodityEditor, name: 'commodityEditor', meta: { title: '供应商申请', foot: true } },
{ path: '/member/supplier/commodityRelease', component: commodityRelease, name: 'commodityRelease', meta: { title: '供应商申请', foot: true } },
{ path: '/member/supplier/selectionClassification', component: selectionClassification, name: 'selectionClassification', meta: { title: '供应商申请', foot: true } },
  //comment
