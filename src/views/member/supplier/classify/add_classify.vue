<template>
    <section id="add-class">
        ...
        <section class="box">
            <ul class="name">
                <li><i class="iconfont icon-info-must"></i>分类名称：</li>
                <li><input type="text" placeholder="请输入分类名称" v-model="classify_name"></li>
            </ul>
            <!-- <ul class="class-img">
                <li><i class="iconfont icon-info-must"></i>分类图片</li>
                <div class="load-img">
                    <el-upload :action="uploadUrl" :on-preview="handlePreview" :limit="1" list-type="picture-card" :show-file-list="false" :on-exceed="handleExceed" :before-upload="beforeUpload" :on-success="handleStoreSuccess">
								...
								<i v-else class="iconfont icon-photobzhaoxiang"></i>
					</el-upload>
                </div>
            </ul> -->
            <!-- <ul class="recommend">
                <li><i class="iconfont icon-info-must"></i>是否推荐</li>
                <li>
            ...
            <ul class="recommend">
                <li><i class="iconfont icon-info-must"></i>是否开启</li>
                <li>
            ...
            <section id="bottom">
                <button type="button" @click="sureAdd">确认添加</button>
            </section>
        </section>
    </section>
</template>
...
<script>
import addClassify from './add_classify_controller.js';
