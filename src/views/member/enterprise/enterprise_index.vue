                    ...
                    <template>
                        <div class="share_holder">
                            <div class="header_box">
                                ...
                                <ul class="left">
                                    <li class="lf" style="line-height:3rem;text-align:center;">{{erchants_name}}</li>
                                </ul>
                                <ul class="right">
                                    <li class="rt" v-if="enterprise_level_li"><span>{{enterprise_level_title}}</span> <br/><span>分红比例:{{enterprise_level_li}}% </span>
                                      </li>
                                      <li v-if="!enterprise_level_li" style="margin-top: 15px;"><span>分红比例:{{erchants_ratio}}% </span></li>
                                </ul>
                            </div>
                ...
                <el-tab-pane label="招商中心" name="enterprise_centre">
                    <template>
                        <div class="share_holder">
                            <div class="header_box">
                                <ul class="left">
                                    <li class="lf" style="line-height:3rem;text-align:center;" v-if="enterpriseCenterInfo_1.has_one_level">{{enterpriseCenterInfo_1.realname}}</li>
                                </ul>
                                <ul class="right">
                                    <li class="rt" v-if="enterpriseCenterInfo_1.has_one_level">{{enterpriseCenterInfo_1.has_one_level.level_name}} <br/>分红比例:{{enterpriseCenterInfo_1.has_one_level.bonus_ratio}}% 
                                      </li>
                                </ul>
                            </div>
