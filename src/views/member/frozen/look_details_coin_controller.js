...
export default{
    ...
    methods: {
		...
		getAllData(){
			$http.get("plugin.froze.Frontend.Modules.Froze.Controllers.records.index",{service_type:0,page:this.all_page},"加载中...").then(res =>{
				if(res.result == 1){
		...
		getIncomeData(){
			$http.get("plugin.froze.Frontend.Modules.Froze.Controllers.records.index",{service_type:1,page:this.income_page},"加载中...").then(res =>{
				if(res.result == 1){
		...
		getPayData(){
			$http.get("plugin.froze.Frontend.Modules.Froze.Controllers.records.index",{service_type:2,page:this.pay_page},"加载中...").then(res =>{
				if(res.result == 1){
		...
		getAllMoreData(){
			...
			if(this.all_page >= this.all_total_page){
				...
				$http.get("plugin.froze.Frontend.Modules.Froze.Controllers.records.index",{service_type:type,page:this.all_page},"正在获取更多...").then(res =>{
					if(res.result == 1){
		...
		getIncomeMoreData(){
			...
			if(this.income_page >= this.income_total_page){
				...
				$http.get("plugin.froze.Frontend.Modules.Froze.Controllers.records.index",{service_type:type,page:this.income_page},"正在获取更多...").then(res =>{
					if(res.result == 1){
