...
export default {
  ...
  methods: {
    ...
    appendAddress() {
      ...
      $http.get('member.member-address.store', { username: this.form.username, mobile: this.form.mobile, city: this.form.city, address: this.form.address, province: this.form.provice, isdefault: this.form.isDefault ? 1 : 0, district: this.form.district, street: this.form.street }).then(function (response) {
