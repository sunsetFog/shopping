...
export default{
    ...
    data(){
        return{
            ...
            uploadUrl:'',
            upImgSrc: '',
            user_information: {card_number: '20180621154230',payee: '中国银行（3260）',money: '￥5000.00'},
            btn_name: '', 
            reason_data: '',
            order_state: '',
        }
    ...
    //上传url
        ...
        completeEvent(){
            ...
            // this.$router.push(this.fun.getUrl('orderlist', { status: this.$route.params.status}));
        },
        //返回
        returnEvent(){
            this.$router.push(this.fun.getUrl("orderdetail",{order_id: this.$route.params.order_id}));
        ...
        // },
        cancelTransfer() {
            this.$confirm('此操作将取消汇款申请, 是否继续?', '提示', {
