        ...
        <div class="section">
            ...
            <div class="close">
                <div class="state">
                    ...
                    <b>{{status_name}}</b>
                    <p v-if="reject_reason">驳回原因:<span>{{reject_reason}}</span></p>
                </div>
                <div class="flow">
                    <h2> 退款申请流程：</h2>
                    <ul>
            ...
            <div class="address" v-if='address.contact'>
                <dl>
                    ...
                    <dd>退货地址：{{address.province_name}} {{address.city_name}} {{address.district_name}} {{address.street_name}} {{address.address}}</dd>
                </dl>
            </div>
            <div class="line"></div>
            <div class="consult-detail">
                <h1>协商详情</h1>
                <ul class="list">
                    <li><span>售后类型：</span> <b> {{refund_type_name}}</b></li>
                    <li><span>退款金额：</span> <b> ¥ {{price}}</b></li>
                    <li><span>退款原因：</span> <b> {{reason}}</b></li>
                    <li><span>退款说明：</span> <b> {{content}}</b></li>
                    <!-- <li><span>售后说明：</span> <b> 测试</b></li>
                    <li><span>售后编号：</span> <b> {{alipay_batch_sn}}</b></li> -->
                    <li><span>申请时间：</span> <b> {{create_time}}</b></li>
                </ul>
            </div>
            
            <div id="bt" v-for="button in button_models">
