<template>
	<div id="refund">
		...
		<mt-popup v-model="popupVisible" position="bottom" style="width:100%;height:18.75rem;">
			<mt-navbar fixed>
				<mt-header fixed title="选择快递" style="background:#ffffff;color:#000000;border-bottom:0.0625rem solid #ebebeb;"></mt-header>
			</mt-navbar>
			<div style="height:2.5rem;"></div>
			<div style="width:100%;height:18.75rem;overflow:scroll;">
				<div v-for="item in options" style="height:2.5rem;line-height:2.5rem;border-bottom:0.0625rem solid #ebebeb;" @click="expressChoose(item)">
					{{item.name}}
				</div>
			</div>
		</mt-popup>
