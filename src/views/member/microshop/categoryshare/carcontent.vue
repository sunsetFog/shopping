...
#carcontent{background: #eee;color: #686868;margin-bottom: 3.75rem;    margin-top: 3%;
	.branch{margin: 0 3%;}
	.sote{clear: both;overflow: hidden;margin-bottom: 0.625rem;}
	h3{text-align: left;
		font-size: 12px;
		margin-left: 3%;
		margin-bottom: 0;
	...
	.fa-bookmark:before{margin-right: 0.375rem;}
	a span{   height: 1.875rem;
	...
	li{width: 29%;text-align: center; float: left;margin-bottom: 0.625rem;margin-right: 4%;font-size: 12px; background:#fff;
