...
<style lang="scss" rel="stylesheet/scss" scoped>
    #brand {
        ...
        #category-content {
        	margin-top: 3.125rem;background: #FFF;
            overflow: hidden;
            width: 100%;
	...
	li{width: 22%;text-align: center; float: left;margin-bottom: 0.625rem;margin-right: 1%;font-size: 12px;box-sizing: border-box;
		img{width: 80%;}
	}
}
</style>