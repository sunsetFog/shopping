...
export default {
    ...
    methods: {
        ...
        //升级会员
        update() {
            this.$router.push(this.fun.getUrl('CourseMemberUpdate', { id: this.courseId }));
        },
        ...
        share(data) {
            ...
            wx.ready(function () {
                ...
                let _desc = (that.fun.isTextEmpty(that.courseShare.share_desc)) ? data.shop.name : that.courseShare.share_desc;
                wx.showOptionMenu();
