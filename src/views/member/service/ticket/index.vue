	...
	<div id="ticket" :class="'ticket'+$store.state.service.lang">
		...
		<div id="sosoall" :class="{onbts:loding}">
			...
			<div class="search-city">
				<div class="city-item-input" @click="selectCity('from')" id="go"><b>{{language.readonly}}</b></div>
				<img src="../../../../assets/images/life-plane01.png">
				<div class="city-item-input" @click="selectCity('to')" id="to"><b>{{language.readonlyto}}</b></div>
			</div>
