    ...
    <div id="trainRefundApplication"  :class="'trainRefundApplication'+$store.state.service.lang">
        ...
        <div class="m-footer">
        	<router-link :to="fun.getUrl('changeAgreement')">
            	<span class="left">退改协议</span>
            </router-link>
            
            <router-link :to="fun.getUrl('ticketOrderDetail')">
            	<span class="right">申请退票</span>
            </router-link>
        </div>
		...
		<div class="modalDetail" v-show="details" @click="closeDetails">
			 <div class="modal-dialog" @click.stop>
				...
				<ul class="detail-list">
					...
					<li class="list"> <span>机票</span> <span class="right">￥750</span></li>
					<li class="list"> <span>机建+燃油</span><span  class="right">￥50</span></li>
				</ul>
				<ul>
					<li class="big"> <span class="left">总额</span> <span class="right">¥850</span> </li>
...
.trainRefundApplicationch{
    ...
    .flight{
		...
		.flightNum{
			...
			div{
				...
				.fromTime{float: left;width:40%;text-align: center;}
				.toTime{float: right;width:40%;text-align: center;}
				.addOne{font-size: 12px;vertical-align: middle;}
			}
			p{
				padding: 0 0.9375rem;
				font-size: 13px;
				.fromAddr{float: left;color:#8c8c8c;width:40%;text-align: center;}
				.toAddr{float: right;color:#8c8c8c;width:40%;text-align: center;}
				.stopCity{color:#333}
			}
		}
	}
	...
	.orderStates{
		...
		.refunds{
			...
			.left{margin-right: 14%;}
		    .right{margin-left: 14%;}
		}
		// p:after{
		// 	display: table;
		// 	content:'';
    ...
    .passenger{
    	...
    	ul{
    		...
    		li{
				...
				justify-content:space-between;
				margin:0 1.25rem;
				text-align: left; border-bottom:0.0625rem solid #ebebeb; height: 4.25rem;padding-top: 0.625rem;	
    			.left{
    				width:90% ; 
    				p{color:#8c8c8c;height: 1.5rem;line-height:1.5rem;font-size: 12px;}
    			}
    			.right{
    				width: 10%; float: left;
    				.circle{
...
.trainRefundApplicationwei{
    ...
    .flight{
		...
		.top{
			...
			span{float: right; padding-left: 0.3125rem;}
		}
		.flightNum{
			background: #fff;
			height: 4.375rem;
    ...
    .passenger{
    	...
    	ul{
    		padding-bottom: 0.625rem;
    		li{text-align: right; border-top:0.0625rem solid #eee; height: 3.125rem;padding-top: 0.3125rem;	
    			.left{
    				width:90% ; float: right;
    				p{color:#7c7c7c;height: 1.5625rem;font-size: 12px;}
    			}
    			.right{
    ...
    .m-footer{
        ...
        a{color: #333;}
        div{width:50%;float: left;height: 2.8125rem; -webkit-box-sizing: border-box;
        -moz-box-sizing: border-box;
        box-sizing: border-box;}
        div.left{border-right:0.0625rem solid #ccc;}
    }
}
</style>