...
<style lang="scss" rel="stylesheet/scss" scoped>
	.trafficCitych {
		...
		.mint-navbar.is-fixed{top:36px;margin-top:3.4375rem;}
		.mint-navbar .mint-tab-item.is-selected{
            height:2.5rem;
            line-height: 2.5rem; 
            border-bottom: 0.125rem solid #1bba9e;color:#1bba9e;}
        .mint-tab-item{
            padding:0.75rem 0;
        }
		.mint-navbar .mint-tab-item:first-child{}
		.innerRig{position: fixed;width: 2.5rem;z-index: 99;right: 0;top:8.5rem;bottom: 0;display: flex;flex-direction: column;color:#8c8c8c;
		    li{flex: 1;}
		}
	...
	.trafficCitywei {
		...
		.mint-navbar.is-fixed{top:2.5rem;margin-top:3.4375rem;}
		.mint-navbar .mint-tab-item.is-selected{border-bottom: 0.125rem solid #1bba9e;color:#1bba9e;}
		.mint-navbar .mint-tab-item:first-child{border-right: #E3E3E3 solid 0.0625rem;}
		.innerRig{position: fixed;width: 2.5rem;z-index: 99;left: 0;top:8.8125rem;bottom: 0;display: flex;flex-direction: column;color:#1bba9e;background: #FFF;
		    li{flex: 1;}
		}
