    ...
    <div id="telephone" :class="'telephone'+$store.state.service.lang">	
        ...
        <div class="m-footer">
            ...
            <div class="integral" v-show="offDeductible">
                <div>
                    <b><!--{{language.score}}-->{{deductionName}}</b> <span>{{language.scoreTip1}}&nbsp;<font>{{score}}</font>&nbsp;{{language.scoreTip2}}<font>&nbsp;{{scoreMoney}}&nbsp;</font>{{language.yuan}}</span>
                </div>
...
.telephonech{
	...
	#telInfo{text-align: left;color:#8c8c8c;height: 1.5rem;line-height: 1.5rem;background: #FFF;display: block;}
	#intel{
        padding-top:0.625rem;
		display: flex;flex-wrap:wrap;align-items:center;align-items:center; justify-content:space-between; line-height: 2.8125rem;height: 2.5rem;
		input{flex: 9;border:0;outline:0;color:#333;font-size:24px;line-height: 1.875rem;}
		i{flex: 1;}
	}
	.telep{
        margin-top:0.625rem;
    ...
    .m-footer{
        box-shadow: 0 0 6px 0px rgba(204,204,204,.4);
        position: fixed;
        bottom:0;
        width:100%;
        background:#fff;
