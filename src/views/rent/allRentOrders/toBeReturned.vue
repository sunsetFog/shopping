...
#toBeReturned{
	.m-header{
		...
		h3{
			...
			font-weight:normal;
			color:#ff9500;
			i{padding-left:0.625rem;color:#919097}
		}
		p{
			clear:both;
			line-height:1.875rem;
			i{padding-right:0.625rem}
		}
		.btn{
			padding:0.625rem 0;
			button{
	...
	.returnAddr{
		...
		.remark{
			...
			text-align:left;
			i{padding-right:0.4375rem;}
		}
	}
	.content{
		background:#fff;
		margin-top:0.625rem;
		.all{border-top:0.0625rem solid #ccc;padding:0.625rem 0.9375rem;text-align:right;height:2.0625rem;line-height:2.0625rem;span{color:#e51c23;font-size:16px;}}
		.data{
			height:3.75rem;
			padding:0.625rem 0.9375rem;
			div.lf{
		...
		.money{
			...
			p:nth-child(3){padding-bottom:0.625rem}
