...
#love_record{
	#money{color: red;font-size: 32px;line-height: 4.5rem;}
	#dingjing{border: 0.0625rem solid #ccc;padding: 0.3125rem 0.625rem;width: 3.125rem;border-radius: 0.625rem;margin:0 auto;margin-bottom: 0.9375rem;}
	#tbsd{border-bottom: 0.0625rem solid #bbbbbb;}
	.tbs{
        display: flex;
        align-items: center;
        background: #FFF;padding: 0.625rem 0.9375rem;
        flex-flow: row wrap;
        border-top: #bbbbbb 0.0625rem solid;    
        box-sizing: border-box;
        font-size: 12px;line-height: 2rem;
        .left {
            flex: 70%;
            text-align: left;
        }
