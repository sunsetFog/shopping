	...
	<div id="commentDetails">
		...
		<div class="pjgoods" v-if="has_one_order_goods">
			<div class="goods">
				...
				<ul class="price">
					<li class="product_price"><small>￥</small>{{has_one_order_goods.price}}</li>
...
#commentDetails {
	...
	#callback{
		...
		button{flex: 1;margin:0 0.875rem;border: #dd191d solid 0.0625rem;border-radius: 0.3125rem;background: #e84e40;color: #FFF;line-height: 1.875rem;margin: 0 0.625rem;}
	}	
	.userimg{border-radius:50%;overflow: hidden; width: 2.5rem; margin-right: 0.625rem;
	...
	.pj {border-bottom: #e8e8e8 solid 0.0625rem;background: #FFF;padding: 0.625rem 0;margin:0 1rem;
		p {text-align: left;margin-top: 0.625rem;line-height: 1.5rem;font-size:14px;}
		img {width: 100%;}
		.name{
			font-size:14px;
		}
...
.goods:after{
	...
	/*	.price {flex: 2;display: flex;flex-direction: column;align-items: flex-end;
		...
		.option {color: #8c8c8c;font-size: 12px;flex: 1;}
